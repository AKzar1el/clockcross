    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if "page_token" not in params:
            return httpx.Response(
                200,
                json={
                    "bars": {"COIN": [{"t": "2026-08-28T13:10:00Z", "o": 1, "h": 2, "l": 1, "c": 2, "v": 10}]},
        ...
        return httpx.Response(
            200,
            json={
                "bars": {"COIN": [{"t": "2026-08-28T13:11:00Z", "o": 2, "h": 3, "l": 2, "c": 3, "v": 11}]},
...
def test_crypto_bars_use_current_v1beta3_us_endpoint() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        return httpx.Response(
            200,
            json={
                "bars": {"BTC/USD": [{"t": "2026-08-28T13:10:00Z", "o": 10, "h": 11, "l": 9, "c": 10.5, "v": 1}]},
                "next_page_token": None,
            },
        )
